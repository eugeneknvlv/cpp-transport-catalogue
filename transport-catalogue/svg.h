...
namespace svg {
    ...
    /*
      Абстрактный класс (интерфейс) для доступа к контейнеру SVG-объектов.
    ...
    */
    ...
    /*
      ...
      подключив SVG-библиотеку. Для этого в нем есть метод Draw, принимающий
      ссылку на интерфейс ObjectContainer
    */
    class Drawable {
    public:
